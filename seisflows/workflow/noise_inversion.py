    ...
    ***
    ...
    def evaluate_objective_function(self, save_residuals=False, **kwargs):
        ...
        if self._force == "Z":
            ...
            # This will generate waveforms in traces/syn/R and/or traces/syn/T
            logger.info("rotating synthetics generated by N and E forces to "
                        "R and T components")
            ...
            # Caluclate misfit for RR and TT synthetics
