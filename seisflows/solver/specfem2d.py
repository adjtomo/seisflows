...
class Specfem2D(Specfem):
    ...
    def eval_grad(self, path, export_traces=True):
        """Inherits from seisflows.solver.specfem.Specfem"""
        self.eval_func(path=path, export_traces=export_traces)
    ...
    def call_solver(self, executable, output="solver.log"):
        """Inherits from seisflows.solver.specfem.Specfem"""
        self.call_solver(executable=executable, output=output)
    ...
    def export_traces(self, path, prefix="traces/obs"):
        """Inherits from seisflows.solver.specfem.Specfem"""
        self.export_traces(path=path, prefix=prefix)
    ...
    def import_traces(self, path):
        """Inherits from seisflows.solver.specfem.Specfem"""
        return self.import_traces(path=path)

    def export_model(self, path, parameters=None):
        """Inherits from seisflows.solver.specfem.Specfem"""
        return self.export_model(path=path, parameters=parameters)

    def export_kernels(self, path):
        """Inherits from seisflows.solver.specfem.Specfem"""
        return self.export_kernels(path=path)

    def export_residuals(self, path):
        """Inherits from seisflows.solver.specfem.Specfem"""
        return self.export_residuals(path=path)
    ...
    def check_mesh_properties(self, path=None):
        """Inherits from seisflows.solver.specfem.Specfem"""
        self.check_mesh_properties(path=path)
