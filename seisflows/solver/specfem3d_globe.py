...
class Specfem3DGlobe(Specfem):
    ...
    ***
    ...
    def kernel_wildcard(self, par="*"):                                          
        ...
        adjoint simulation. An example SPECFEM3D_GLOBE kernel filename (in
        FORTRAN binary file format) is: 'proc000001_reg1_rho_kernel.bin'
        ...
        :return: wildcard identifier for channels                                
        """                                                                      
        return f"proc??????_reg?_{par}_kernel{self._ext}"    
    ...
    def model_databases(self):
        ...
        This can be determined by 'LOCAL_PATH' in the Par_file
        """
    ...
    def adjoint_simulation(self, executables=None, save_kernels=False,
        ...
        if self.materials in ["ACOUSTIC", "ELASTIC", "ISOTROPIC"]:
            anisotropic_kl = ".false."
            save_transverse_kl_only = ".false."
        elif self.materials == "ANISOTROPIC":
            anisotropic_kl = ".true."
            save_transverse_kl_only = ".true."
        elif self.materials == "FULLY_ANISOTROPIC":
