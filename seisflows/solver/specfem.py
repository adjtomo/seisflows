...
class Specfem:
    ...
    ***
    ...
    @property
    def forward_array_wildcard(self):
        """
        Returns a wildcard identifier to search for forward arrays and absorb
        buffers generated by SPECFEM which are generated by forward simulations
        when `save_forward` = True, and used as input for adjoint simulations.

        SPECFEM2D has no forward array files
        """
        return f""

    @property
    def absorb_wildcard(self):
        """
        Returns a wildcard identifier to search for absorb fields and
        buffers generated by SPECFEM which are used during forward simulation.

        For SPECFEM2D this file looks like: 'absorb_elastic_left000000.bin'
        """
        return f"absorb_*_*{self._ext}"
