# -*- coding: utf-8 -*-
#
# SeisFlows documentation build configuration file, created by
...
htmlhelp_basename = 'SeisFlowsdoc'
...
texinfo_documents = [
  ('index', 'SeisFlows', u'SeisFlows Documentation',
   u'Princeton University', 'SeisFlows', 'One line description of project.',
   'Miscellaneous'),
]
